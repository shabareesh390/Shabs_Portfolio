...
const $$splitComponentImporter = () => import("./index-C9iWuZ7M.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Shabareesh S Gowda — Flutter & Software Developer"
    }, {
      property: "og:description",
      content: "Portfolio · Flutter · Java · DSA · Open for internships."
    }, {
      property: "og:type",
      content: "website"
    }, {
